...
\renewcommand{\cftchappagefont}{\fontsize{16}{24}\selectfont\heiti}
\renewcommand{\cftsecpagefont}{\fontsize{15}{22.5}\selectfont\heiti}
\renewcommand{\cftsubsecpagefont}{\fontsize{14}{21}\selectfont\heiti}
%间距（规范中未对目录不同项之间的间距做规定，以下数值取半倍行高）
